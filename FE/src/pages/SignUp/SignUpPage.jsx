      ...
      <Container>
        {currentStep === 1 && (
          <>
            ...
            <InputWrapper>
              ...
              />
              <ErrorMessage isSeller={isSeller}>
            ...
            <InputWithButton>
              ...
              />
              <ButtonInInput isSeller={isSeller} onClick={requestAuthCode}>
                인증요청
              </ButtonInInput>
            </InputWithButton>
            <InputWithButton>
              ...
              />
              <ButtonInInput isSeller={isSeller} onClick={verifyAuthCode}>
                인증완료
              </ButtonInInput>
            </InputWithButton>
            <Button onClick={handleSignUpInfoSubmit} isSeller={isSeller}>
              회원가입
            </Button>
          </>
        )}
        {currentStep === 2 && (
          <>
            ...
            <Button onClick={handleApprovalPage} isSeller={isSeller}>
              회원가입
            </Button>
          </>
        )}
        {currentStep === 3 && (
          <Container>
            ...
            {isSeller ? (
              <Button onClick={handleMain} isSeller={isSeller}>
                메인으로 돌아가기
              </Button>
            ) : (
              <>
